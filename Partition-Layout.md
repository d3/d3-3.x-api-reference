> [API Reference](API-Reference.md) ▸ [Layouts](Layouts.md) ▸ [Hierarchy](Hierarchy-Layout.md) ▸ **Partition Layout**
...
[![partition](img/partition.png)](http://bl.ocks.org/mbostock/4063423)
